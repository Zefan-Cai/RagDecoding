...
python -m open_instruct.eval.MuSiQue.run_eval_RAG \
    ...
    --file_withoutDoc musique_0doc_3220_4834.jsonl \
    --file_withDoc musique_20doc_3220_4834.jsonl \
    --save_dir ${base_dir}/results/musique_RAGDecoding_20doc_llama2chat_part3/ \

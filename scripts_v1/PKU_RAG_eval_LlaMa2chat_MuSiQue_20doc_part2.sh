...
python -m open_instruct.eval.MuSiQue.run_eval_RAG \
    ...
    --file_withoutDoc musique_0doc_1610_3220.jsonl \
    --file_withDoc musique_20doc_1610_3220.jsonl \
    --save_dir ${base_dir}/results/musique_RAGDecoding_20doc_llama2chat_part2/ \
